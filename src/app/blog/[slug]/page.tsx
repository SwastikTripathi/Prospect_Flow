        ...
        <div className="container mx-auto px-[5vw] md:px-[8vw] lg:px-[10vw] max-w-screen-xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-x-8 lg:gap-x-12 xl:gap-x-16">
            <div className="lg:col-span-8 order-2 lg:order-1">
              ...
              <div className="mt-12"> {/* Increased top margin for the entire author credit section */}
                 ...
                 <div className="mt-8 py-4 flex items-start gap-x-4"> {/* Kept mt-8 for the inner div for balance */}
                    <div>
                        <Image
                        src="https://placehold.co/60x60.png" /* Changed image size */
                        alt={creditAuthorName}
                        width={60} /* Changed image size */
                        height={60} /* Changed image size */
                        className="rounded-full"
                        data-ai-hint="author portrait"
                        />
                    </div>
                    <div className="flex-1">
                        {/* "Article written by" text removed */}
